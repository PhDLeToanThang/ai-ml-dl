...
>>Các tiêu chuẩn bảo mật an ninh an toàn thông tin trên thế giới và việt nam, đặc biệt các điều luật của ngành ngân hàng, tài chính, tổ chức FinTech, tổ chức cổng giao dịch điện tử, hệ thống chứng Khoán đã có những điều luật, quy định gì hoặc khung pháp lý cụ thể gì để bảo mật an toàn quy định giám sát áp dụng AI,ML trong thu thập, xử lý và hỗ trợ phân tích dữ liệu kiểm toán nội bộ ? và nếu áp dụng cho vấn đề SSO, MFA cho iAM Security Platform cho Private Local, Microsoft Entra ID, Okto, SAS Platform, KNIME K-AI cho các mô hình AI thì so sánh giữa các loại AI LocalPrivate, AI Public.
...
# Data Framework và AI/ML/DL thì ứng dụng các khung bảo mật An ninh An toàn gì?

>> Các tiêu chuẩn bảo mật an ninh an toàn thông tin trên thế giới và việt nam, đặc biệt các điều luật của ngành ngân hàng, tài chính, tổ chức FinTech, tổ chức cổng giao dịch điện tử, hệ thống chứng Khoán đã có những điều luật, quy định gì hoặc khung pháp lý cụ thể gì để bảo mật an toàn quy định giám sát áp dụng AI,ML trong thu thập, xử lý và hỗ trợ phân tích dữ liệu kiểm toán nội bộ, quản trị rủi ro và Kiểm toán nội bộ CNTT áp dụng AI ? và nêu ra SAS Platform với KNIME Data Analytics Platform thì 2 ứng dụng trên so sánh với nhau trên các tính năng có thể tùy biến như: SSO đăng nhập không cần Internet để sử dụng AI Local (chỉ có mạng nội bộ, không dùng internet), các phiên bản SSO iAM Security Platform, Microsoft EntraID, Okta và những công nghệ MFA khác có công nghệ nào chỉ cần mạng nội bộ và không cần mạng internet để tích hợp với SAS và KNIME và dùng để cấp token local cho AI Assistant chạy nội bộ?
